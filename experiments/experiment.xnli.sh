sentiment () {
  ...
  LA_DATA="english"
  LA="en"
  python experiments/finetune_sentiment.py -n "${LA_DATA}" -m "${LM}" -o "ckpts/${LM_ALIAS}-${LA}" --repo-id "cardiffnlp/${LM_ALIAS}-tweet-sentiment-${LA}"
...
python experiments/finetune_sentiment.py -n "english" -m "roberta-base" -o "ckpts/roberta-base-en" --repo-id "cardiffnlp/roberta-base-tweet-sentiment-en"
python experiments/finetune_sentiment.py -n "french" -m "camembert-base" -o "ckpts/camembert-base-fr" --repo-id "cardiffnlp/camembert-base-tweet-sentiment-fr"
